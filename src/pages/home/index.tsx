...
    switchTab({ url: '/pages/ai-advisor/index' })
  }
...
          <View
            className="flex flex-row items-center bg-card rounded-full px-4 py-2 border border-border shadow-sm active-press"
            onClick={handleNavigateToProfile}
          >
            <View className="i-mdi-account-circle text-2xl text-primary mr-2" />
            <Text className="text-lg font-medium text-foreground">个人中心</Text>
          </View>
        </View>
        {/* 顶部：签到按钮 + 积分显示 */}
